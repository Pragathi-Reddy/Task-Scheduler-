...
Future Enhancements
🔍 Task Search:
Allow users to search for tasks by name or category.

🔁 Recurring Tasks:
Support for recurring tasks with daily, weekly, or monthly options.

🧑‍💻 Task Sorting:
Ability to sort tasks by priority or due date.
